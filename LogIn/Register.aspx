        ...
        <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">    
                        ...
                        <li class="active"> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="Register.aspx">Register</asp:HyperLink></li>
            ...
            <form role="form" id="RegisterForm" runat="server">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="firstNameValidator1" runat="server" ControlToValidate="txtFirstName" ErrorMessage="First name is a required field." ForeColor="#FF6600"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="Last Name: "></asp:Label>
                        <asp:TextBox ID="txtLastName" CssClass="form-control" runat="server" Width="279px" ForeColor="Red"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLastName" ErrorMessage="Last name is a required field." ForeColor="#FF6600"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAddress" ErrorMessage="Address is a required field." ForeColor="#FF6600"></asp:RequiredFieldValidator>
                    </div>
                   <div class="form-inline">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCity" ErrorMessage="City is a required field." ForeColor="#FF6600"></asp:RequiredFieldValidator>
                    <div class="form-group">
                    ...
                    <asp:TextBox ID="txtCountry" CssClass="form-control" runat="server" Width="147px" ForeColor="Red"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtCountry" ErrorMessage="Country is a required field" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                          </div>
                    <div class="form-group">
                ...
                <div class="col-lg-5">
                   ...
                   <asp:TextBox ID="txtHomePhone" CssClass="form-control" runat="server" Width="147px" ForeColor="Red"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtHomePhone" Display="Dynamic" ErrorMessage="Phone number is Invalid, please try again" ForeColor="#FF6600" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"></asp:RegularExpressionValidator>
                   ...
                   <asp:TextBox ID="txtBusPhone" CssClass="form-control" runat="server" Width="147px" ForeColor="Red"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtBusPhone" ErrorMessage="Phone number is invalid, please try again" ForeColor="#FF6600" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"></asp:RegularExpressionValidator>
                        </div>
                    <div class="form-group">                 
                ...
                <asp:Label ID="Label12" runat="server" Text="Password: "></asp:Label>
                  <asp:TextBox ID="txtPass1" type="password" runat="server" CssClass="form-control" Width="183px" ForeColor="Red"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPass1" ErrorMessage="Please enter a password" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">    
                <asp:Label ID="Label13" runat="server" Text="Confirm: "></asp:Label>
                   <asp:TextBox type="password" ID="txtPass2" runat="server" CssClass="form-control" Width="183px" ForeColor="Red"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPass2" ErrorMessage="Please confirm your password" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                        </div>   
                    </div>
                   <br />
